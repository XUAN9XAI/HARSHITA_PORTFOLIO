...
const experiences = [
  { icon: Users, title: "Robotics Tutor", org: "BrightChamps", desc: "Mentored 100+ students in robotics fundamentals and programming." },
  { icon: GraduationCap, title: "NPTEL Certification", org: "Advanced Aircraft Control", desc: "Completed advanced coursework in control systems and aerospace engineering." },
  { icon: Presentation, title: "Seminar Speaker", org: "BITS Pilani — Digital Dreamscapes", desc: "Presented research on digital innovation and emerging technologies." },
];
    ...
    <section id="experience" className="section-padding" ref={ref}>
      <div className="mx-auto max-w-6xl">
        <motion.div initial={{ opacity: 0, y: 40 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <p className="mb-2 font-mono text-xs uppercase tracking-widest text-primary">{t("experience.label")}</p>
